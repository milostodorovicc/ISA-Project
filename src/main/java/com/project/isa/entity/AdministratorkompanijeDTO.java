...
public class AdministratorkompanijeDTO {
    ...
    public AdministratorkompanijeDTO(String emailadresa, String lozinka, String ime, String prezime, String grad, String drzava, Long brojtelefona, String zanimanje, String infoopred) {
        this.emailadresa = emailadresa;
        this.lozinka = lozinka;
        this.ime = ime;
        this.prezime = prezime;
    ...
    public AdministratorkompanijeDTO() {
    }
}
